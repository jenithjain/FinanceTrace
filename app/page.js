...
import {
  DollarSign, TrendingUp, Sparkles, PieChart, BarChart3, FileText,
  Zap, Shield, Users, Wallet
} from "lucide-react";
          ...
          <div className="order-2 flex flex-col items-start md:order-1">
            <div className="mb-4 sm:mb-6 flex items-center gap-3">
              ...
              <div className="leading-tight">
                <div className="text-lg sm:text-2xl font-semibold text-slate-900 dark:text-white">Finance Dashboard</div>
                <div className="text-xs text-slate-500 dark:text-slate-400">Smart Financial Management</div>
              </div>
            </div>
            ...
            <p className="mb-6 sm:mb-8 max-w-xl text-base sm:text-lg leading-relaxed text-slate-700 dark:text-slate-300">
              Track income, expenses, and financial health with intelligent analytics. Get real-time insights, category-wise spending breakdowns, and monthly trends to make smarter financial decisions.
            </p>
          ...
          <div className="order-1 md:order-2 w-full relative">
            ...
            <div className="absolute -top-4 -right-4 sm:top-8 sm:right-8 z-20 animate-float">
              <div className="flex items-center gap-3 bg-linear-to-r from-emerald-500/90 to-teal-500/90 backdrop-blur-md rounded-full px-4 py-3 shadow-xl border border-emerald-400/30">
                ...
                <div className="text-left">
                  <p className="text-white font-semibold text-sm ivy-font">Income Tracking</p>
                  <p className="text-white/80 text-xs ivy-font">+15.2% This Month</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-4 -left-4 sm:bottom-12 sm:left-4 z-20 animate-float-delayed">
              <div className="flex items-center gap-3 bg-linear-to-r from-blue-500/90 to-cyan-500/90 backdrop-blur-md rounded-full px-4 py-3 shadow-xl border border-blue-400/30">
                ...
                <div className="text-left">
                  <p className="text-white font-semibold text-sm ivy-font">Category Analytics</p>
                  <p className="text-white/80 text-xs ivy-font">8 Categories Tracked</p>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              AI-powered financial analytics, real-time expense tracking, and intelligent insights to help you make better financial decisions
            </p>
          </div>
            ...
            <div className="relative z-10 p-8 sm:p-12 lg:p-16">
              <div className="max-w-xl">
                ...
                <p className="text-lg text-slate-700 dark:text-slate-200 mb-6">
                  Intelligent financial tracking across all your income and expenses, automatically categorizing transactions and providing real-time insights into your spending patterns.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-border/40 backdrop-blur-sm bg-card/50 cursor-pointer">
              <CardHeader>
                ...
                <CardTitle className="text-xl ivy-font">Income & Expense Tracking</CardTitle>
                <CardDescription className="ivy-font">
                  Track all your income sources and expenses in one place. Get a complete picture of your cash flow with automatic categorization.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-border/40 backdrop-blur-sm bg-card/50 cursor-pointer">
              <CardHeader>
                <div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center mb-4 group-hover:bg-blue-500 transition-colors">
                  <PieChart className="h-6 w-6 text-blue-500 group-hover:text-white transition-colors" />
                </div>
                <CardTitle className="text-xl ivy-font">Category Analytics</CardTitle>
                <CardDescription className="ivy-font">
                  Visualize spending by category with beautiful pie charts and bar graphs. Understand exactly where your money goes each month.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-border/40 backdrop-blur-sm bg-card/50 cursor-pointer">
              <CardHeader>
                <div className="w-12 h-12 rounded-xl bg-purple-500/10 flex items-center justify-center mb-4 group-hover:bg-purple-500 transition-colors">
                  <BarChart3 className="h-6 w-6 text-purple-500 group-hover:text-white transition-colors" />
                </div>
                <CardTitle className="text-xl ivy-font">Monthly Trends</CardTitle>
                <CardDescription className="ivy-font">
                  Track your financial trends over time with interactive monthly reports. Spot patterns and make informed decisions.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-border/40 backdrop-blur-sm bg-card/50 cursor-pointer">
              <CardHeader>
                ...
                <CardTitle className="text-xl ivy-font">Net Balance Overview</CardTitle>
                <CardDescription className="ivy-font">
                  Real-time net balance calculation showing your financial health at a glance. Know your position instantly.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-border/40 backdrop-blur-sm bg-card/50 cursor-pointer">
              <CardHeader>
                ...
                <CardTitle className="text-xl ivy-font">Role-Based Access</CardTitle>
                <CardDescription className="ivy-font">
                  Secure access control with viewer, analyst, and admin roles. Protect sensitive financial data with proper permissions.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-border/40 backdrop-blur-sm bg-card/50 cursor-pointer">
              <CardHeader>
                ...
                <CardTitle className="text-xl ivy-font">Multi-User Support</CardTitle>
                <CardDescription className="ivy-font">
                  Manage finances as a team with shared dashboards and role-based permissions for different team members.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
