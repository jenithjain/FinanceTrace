      ...
      <Card className="w-full max-w-md border-white/10 bg-black/40 backdrop-blur-xl">
        ...
        <CardContent className="space-y-4">
          ...
          <form onSubmit={handleCredentialsAuth} className="space-y-4">
            ...
            {isSignUp && (
              <div className="space-y-2">
                <Label htmlFor="requestedRole" className="text-gray-300">Request Role</Label>
                <select
                  id="requestedRole"
                  name="requestedRole"
                ...
                >
                  <option value="viewer" className="text-black">Viewer (instant access)</option>
                  <option value="analyst" className="text-black">Analyst (requires admin approval)</option>
                  <option value="admin" className="text-black">Admin (requires admin approval)</option>
                </select>
              </div>
            )}
